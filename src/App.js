...
import { Sun, Moon, Phone, Mail, MapPin, Facebook, Instagram, Linkedin } from "lucide-react"
...
export default function App() {
  ...
  return (
    <div className="font-sans bg-gray-100 dark:bg-gray-950 text-gray-800 dark:text-gray-100">
        ...
        <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel">
          <div className="carousel-inner">
            ...
            <div className="carousel-item">
              <img src="/imagens/image.png" className="d-block w-full h-screen object-cover" alt="Serviços de Design" />
              <div className="carousel-caption d-none d-md-block bg-black bg-opacity-70 rounded p-4">
      ...
      {isHeaderVisible && (
        <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md">
          <nav className="container mx-auto p-4 flex justify-between items-center">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">ASA Personalizados</h1>
            ...
            <Button onClick={toggleTheme} className="p-2 bg-gray-200 dark:bg-gray-700 rounded-full transition-colors">
      ...
      <main>
        <section ref={sectionRefs.sobre} className="py-20 bg-white dark:bg-gray-900">
          <div className="container mx-auto px-4">
            <h1 className="text-5xl font-bold mb-8 text-center">ASA Personalizados</h1>
            <h2 className="text-3xl text-gray-600 dark:text-gray-300 mb-10 text-center">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {services.map((service, index) => (
                <Card
                  key={index}
                  className="bg-white dark:bg-gray-700 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300"
                >
                  <img
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
              <div>
                ...
                <p className="mb-6 text-gray-300">Transformando ideias em soluções digitais inovadoras desde 2010.</p>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center">
                    ...
                    <a href="https://wa.me/5518996791377" className="text-gray-300 hover:text-white transition-colors">
                      (18) 99679-1377
                    </a>
                  </li>
                  <li className="flex items-center">
                    <Phone size={18} className="mr-2 text-blue-400" />
                    <a href="https://wa.me/5518996798352" className="text-gray-300 hover:text-white transition-colors">
                      (18) 99679-8352
                    </a>
                  </li>
                  <li className="flex items-center">
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-300">Presidente Prudente, SP</span>
                  </li>
                </ul>
              </div>
            </div>
